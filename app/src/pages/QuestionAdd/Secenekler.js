...
export default class Secenekler extends React.Component{
  constructor(props){
    super(props);
  }
          ...
          this.props.secenekler.map(function(item) {
                ...
                return (
                  <div key={item.id} style={styles.secenekBox}>
                      ...
                      <RaisedButton primary={true} onClick={_this.deleteOption.bind(_this,item )} style={{float:"right"}}> Sil</RaisedButton>
                  </div>
                 )
          })
        }
