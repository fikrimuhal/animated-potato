...
export default class CategoryWeights extends React.Component {
    ...
    categorySelected = function (selectedCategory, event) {
        ...
        var foundKey = oldCategoryWeights.findKey(x => {
            return x.get("id") == selectedCategory
        });
    ...
    shouldComponentUpdate = function (nextProps, nextState) {
        ...
        currentCategoryList = Immutable.fromJS(currentCategoryList, (key, value)=> {
            return value.toOrderedMap();
        });
        nextCategoryList = Immutable.fromJS(nextCategoryList, (key, value)=> {
            return value.toOrderedMap();
        });
                ...
                <Row>
                    {
                        this.props.categoryList.map((item) => {
                            ...
                            let foundKey = categoryWeights.findKey(x=> {
                                return x.toJS().id == item.id;
                            });
